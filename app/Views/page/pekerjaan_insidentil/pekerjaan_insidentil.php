...
<head>
  ...
  <title>Pekerjaan Insidentil | Sistem Manajemen Perumahan</title>
...
<table  id="dataInsidentilTable" class="display table table-striped table-bordered w-100">
    ...
    <?php
      ...
      /** @var list<array<string, mixed>> $mandor */
      /** @var string|null $role */
      $perumahan = is_array($perumahan ?? null) ? $perumahan : [];
      $mandor = is_array($mandor ?? null) ? $mandor : [];
